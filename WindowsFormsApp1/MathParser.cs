...
namespace WindowsFormsApp1 {
    public class MathParser
    {
        ...
        public MathParser()
        {
            ...
            {
                throw new FormatException("Ошибка: не удается прочитать десятичный разделитель символов из системы, проверьте свои региональные настройки.", ex);
            }
        }
        ...
        private string FormatString(string expression) {
            if (string.IsNullOrEmpty(expression)) {
                throw new ArgumentNullException("Выражение равно нулю или пусто");
            }
            ...
            if (balanceOfParenth != 0) {
                throw new FormatException("Количество левых и правых скобок не равно");
            }
        ...
        private string ConvertToRPN(string expression)
        {
            ...
            while (stack.Count > 0)
            {
                ...
                {
                    throw new FormatException("Исключение формата,"
                    + " существует функция без круглых скобок");
                }
            }
        ...
        private string LexicalAnalysisInfixNotation(string expression, ref int pos)
        {
                ...
                || supportedConstants.ContainsKey(token.ToString()))
            {
                ...
                {
                    throw new ArgumentException("Неизвестный токен");
                }
